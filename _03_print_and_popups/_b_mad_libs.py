...
if __name__ == '__main__':
    ...
    question = simpledialog.askstring(title='MadLibs', prompt="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adjective = simpledialog.askstring(title= 'Adjective', prompt="Please enter an adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title= 'Liquid', prompt="Please enter a type of liquid")
    # Get the player to enter a body part
    bodyPart = simpledialog.askstring(title='BodyPart', prompt="Please enter a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='verb', prompt="Please enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title='place',prompt="Please enter a place")
    ...
    final = simpledialog.askstring(title='Final Story',prompt=story)
